  ...
  return (
    <div className={`flex flex-col min-h-screen ${getBackground()} text-white transition-colors duration-500`}>
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 py-4 sm:py-8 relative z-10">
        ...
        <div className="mt-16 max-w-4xl mx-auto text-gray-300 px-4 sm:px-6">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold mt-8 mb-4 text-white">Educational Applications and Teaching Resources</h3>
          <p className="mb-4 text-sm sm:text-base">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold mt-8 mb-4 text-white">Fun Games and Recreational Activities</h3>
          <p className="mb-4 text-sm sm:text-base">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold mt-8 mb-4 text-white">Why Our Random Letter Generator Stands Out</h3>
          <p className="mb-4 text-sm sm:text-base">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold mt-8 mb-4 text-white">Frequently Asked Questions About Random Letter Generation</h3>
          <div className="space-y-4 mb-8">
            <div>
              <h4 className="text-lg sm:text-xl font-medium text-white">How does the Random Letter Generator ensure true randomness?</h4>
              <p className="text-sm sm:text-base">Our Random Letter Generator utilizes cryptographically secure pseudorandom number generation (CSPRNG) algorithms to produce statistically random results. This ensures that each letter has an equal probability of being selected, eliminating patterns or biases that might occur with simpler random number generators.</p>
            </div>
            <div>
              <h4 className="text-lg sm:text-xl font-medium text-white">Is the Random Letter Generator compatible with all devices and browsers?</h4>
              <p className="text-sm sm:text-base">Yes, our Random Letter Generator is built with responsive design principles and modern web technologies, ensuring compatibility with all major browsers (Chrome, Firefox, Safari, Edge) and devices (smartphones, tablets, laptops, and desktop computers). The interface automatically adjusts to provide optimal viewing and interaction regardless of screen size.</p>
            </div>
            <div>
              <h4 className="text-lg sm:text-xl font-medium text-white">How can I customize the letter selection to exclude certain letters?</h4>
              <p className="text-sm sm:text-base">While our current version allows you to exclude vowels (A, E, I, O, U) through the settings panel, we&apos;re developing an advanced customization feature that will enable users to exclude specific letters or select custom letter sets. This feature will be available in an upcoming update.</p>
            </div>
            <div>
              <h4 className="text-lg sm:text-xl font-medium text-white">Can I save or share my random letter results?</h4>
              <p className="text-sm sm:text-base">We&apos;re currently implementing a feature that will allow users to save their random letter history and share results via social media or direct links. This functionality will be particularly useful for educational settings and remote learning environments.</p>
            </div>
            <div>
              <h4 className="text-lg sm:text-xl font-medium text-white">Is there a limit to how many letters I can generate?</h4>
              <p className="text-sm sm:text-base">No, our Random Letter Generator allows unlimited letter generation with no daily caps or usage restrictions. You can spin the wheel as many times as needed for your educational activities, games, or creative projects.</p>
            </div>
            <div>
              <h4 className="text-lg sm:text-xl font-medium text-white">How can teachers effectively incorporate the Random Letter Generator into classroom activities?</h4>
              <p className="text-sm sm:text-base">Teachers can project the Random Letter Generator on a classroom screen for whole-class activities, use it for small group rotations, or recommend it for individual student practice. The visual spinning wheel creates engagement while the customization options allow for differentiated instruction based on student needs and learning objectives.</p>
            </div>
          </div>

          <div className="bg-gray-800/50 p-4 sm:p-6 rounded-lg border border-gray-700 mb-8">
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-white">Start Generating Random Letters Today</h3>
            <p className="mb-4 text-sm sm:text-base">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/pictionary" className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                Try Our Pictionary Word Generator
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </Link>
              <Link href="/blog/pictionary-word-generator" className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
      ...
      <footer className="py-6 sm:py-8 px-4 sm:px-6 border-t border-gray-800 text-center text-gray-500 text-xs sm:text-sm relative z-10">
