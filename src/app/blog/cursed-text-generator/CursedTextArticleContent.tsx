      ...
      <article className="prose prose-lg max-w-4xl mx-auto bg-white">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-purple-900 mt-2">
                <strong>Zalgo text</strong> (also known as &ldquo;corrupted text&rdquo; or &ldquo;glitch text&rdquo;) is a digital text phenomenon where normal characters appear to be corrupted by excessive diacritical marks stacking above and below the line.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm my-6">
          <ul className="list-disc pl-5 space-y-3 text-gray-800">
            ...
            <li>
              <strong className="text-gray-900">Glitch</strong>: Randomly inserts special characters and symbols into your text, creating a &ldquo;glitched&rdquo; computer effect. Adjust intensity to control how frequently these characters appear.
            </li>
            <li>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm my-6">
          <ol className="list-decimal pl-5 space-y-3 text-gray-800">
            ...
            <li>
              <strong className="text-gray-900">Generate</strong>: Click the &ldquo;Generate&rdquo; button to transform your text.
            </li>
            <li>
              <strong className="text-gray-900">Copy Result</strong>: Click the &ldquo;Copy&rdquo; button to copy the transformed text to your clipboard, ready to paste anywhere.
            </li>
            <li>
